...
public class Prototype {
    ...
    static {
        ...
        commands.put("1",param -> {
            testMode = true;
           System.out.print("Please specifiy the test directory: ");
           ...
           int i = 0;
           while(true) {
               File testf = new File(path + "/test" + i + ".txt");
               File outputf = new File(path + "/output" + i + ".txt");
               if(!testf.exists() || !outputf.exists()) {
                   if(i == 0) System.out.println("Cannot find any tests in the directory.");
                   break;
               }
    ...
    private static boolean processLine(String _line) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, FileNotFoundException {
    ...
    private static void readInputFromScanner(Scanner scanner,boolean fromfile) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, FileNotFoundException {
